...
INSERT INTO TRENER(korisnickoime, lozinka, ime, prezime, brtelefona, email, datumrodjenja, uloga, aktivan, fitnesscentar_id) VALUES('srdjanvasic','hfnc73748', 'Srdjan', 'Vasic', '0692435647', 'srkiivas@gmail.com', '1997-12-03', 'TRENER', true, 2);
...
INSERT INTO TRENING(naziv, opis, tip, trajanje, trener_id) VALUES('Kardio trening', 'Kardio trening za celo telo','CARDIO', 1.5, 6);
INSERT INTO TRENING(naziv, opis, tip, trajanje, trener_id) VALUES('Joga', 'Joga za opustanje','YOGA', 1.0, 2);
INSERT INTO TRENING(naziv, opis, tip, trajanje, trener_id) VALUES('Joga', 'Joga za opustanje','YOGA', 1.0, 6);
INSERT INTO TRENING(naziv, opis, tip, trajanje, trener_id) VALUES('Kikboks', 'Borilacki tip treninga', 'KICKBOX', 2.5, 3);
INSERT INTO TRENING(naziv, opis, tip, trajanje, trener_id) VALUES('Kikboks', 'Borilacki tip treninga', 'KICKBOX', 2.5, 4);
INSERT INTO TRENING(naziv, opis, tip, trajanje, trener_id) VALUES('Hiit', 'Vezbe', 'HIIT', 2, 3);
INSERT INTO TRENING(naziv, opis, tip, trajanje, trener_id) VALUES('Hiit', 'Vezbe', 'HIIT', 2, 4);
...
INSERT INTO TERMIN(br_prijavljenih_clanova, cena, datum, vreme, sala_id, trening_id) VALUES(0, 1200.0, '2021-7-9', '20:00', 3, 1);
INSERT INTO TERMIN(br_prijavljenih_clanova, cena, datum, vreme, sala_id, trening_id) VALUES(0, 1500.0, '2021-7-7', '17:00', 2, 2);
INSERT INTO TERMIN(br_prijavljenih_clanova, cena, datum, vreme, sala_id, trening_id) VALUES(0, 1500.0, '2021-7-14', '17:00', 2, 2);
...
INSERT INTO TERMIN(br_prijavljenih_clanova, cena, datum, vreme, sala_id, trening_id) VALUES(0, 2500.0, '2021-7-14', '21:00', 2, 6);
INSERT INTO TERMIN(br_prijavljenih_clanova, cena, datum, vreme, sala_id, trening_id) VALUES(0, 2300.0, '2021-7-8', '20:00', 2, 7);
INSERT INTO TERMIN(br_prijavljenih_clanova, cena, datum, vreme, sala_id, trening_id) VALUES(0, 2300.0, '2021-7-15', '20:00', 2, 8);
INSERT INTO TERMIN(br_prijavljenih_clanova, cena, datum, vreme, sala_id, trening_id) VALUES(0, 1000.0, '2021-7-3', '11:00', 3, 9);
